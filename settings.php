    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group" id="settings-tabs" role="tablist">
                <a class="list-group-item list-group-item-action" id="courses-tab" data-bs-toggle="list" href="#courses-pane" role="tab"><i class="bi bi-book me-2"></i> Course Management</a>
                <a class="list-group-item list-group-item-action" id="batches-tab" data-bs-toggle="list" href="#batches-pane" role="tab"><i class="bi bi-calendar-event me-2"></i> Batch Management</a>
                <a class="list-group-item list-group-item-action" id="pipeline-tab" data-bs-toggle="list" href="#pipeline-pane" role="tab"><i class="bi bi-diagram-3 me-2"></i> Pipeline Editor</a>
                <a class="list-group-item list-group-item-action active" id="users-tab" data-bs-toggle="list" href="#users-pane" role="tab"><i class="bi bi-people me-2"></i> User Management</a>
                <a class="list-group-item list-group-item-action" id="custom-fields-tab" data-bs-toggle="list" href="#custom-fields-pane" role="tab"><i class="bi bi-list-columns-reverse me-2"></i> Custom Fields</a>
                <a class="list-group-item list-group-item-action" id="integrations-tab" data-bs-toggle="list" href="#integrations-pane" role="tab"><i class="bi bi-globe me-2"></i> Integrations</a>
                <a class="list-group-item list-group-item-action" id="bulk-import-tab" data-bs-toggle="list" href="#bulk-import-pane" role="tab"><i class="bi bi-cloud-upload me-2"></i> Bulk Import</a>
            </div>
        </div>
        <div class="col-md-9">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="courses-pane" role="tabpanel">
                     <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCourseModal"><i class="bi bi-plus-lg"></i> Add New Course</button>
                    </div>
                ...
                <div class="tab-pane fade" id="batches-pane" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBatchModal"><i class="bi bi-plus-lg"></i> Add New Batch</button>
                    </div>
                ...
                <div class="tab-pane fade" id="pipeline-pane" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addStageModal"><i class="bi bi-plus-lg"></i> Add New Stage</button>
                    </div>
                ...
                <div class="tab-pane fade show active" id="users-pane" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addUserModal"><i class="bi bi-person-plus-fill"></i> Invite New User</button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-hover">
                                <thead><tr><th>Name</th><th>Username</th><th>Role</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                ...
                <div class="tab-pane fade" id="custom-fields-pane" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCustomFieldModal"><i class="bi bi-plus-lg"></i> Add New Field</button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-hover">
                    ...
                    <div class="card mb-3" data-platform="meta">
                        ...
                        <div class="card-body">
                            ...
                            <form id="meta-mapping-form">
                                <table class="table table-bordered table-sm"><thead><tr><th>Meta Field</th><th>CRM Field</th></tr></thead><tbody id="meta-mapping-table"><tr><td colspan="2" class="text-center text-muted">Load Meta Forms to map fields.</td></tr></tbody></table>
                            ...
                            <form id="bulk-import-form">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary" type="button" id="fetch-sheets-button"><i class="bi bi-search"></i> Get Sheets</button>
                                        <span class="input-group-text">OR</span>
                                        <input type="file" class="form-control" id="csv_file_upload" name="csv_file_upload" accept=".csv">
                                    </div>
                                </div>

                                <div class="mb-3 d-none" id="sheet-select-container">
                                    <label class="form-label text-primary fw-bold">Select Sheet to Import:</label>
                                    <select class="form-select" id="google-sheet-selector">
